<div class="row">
    <div class="col-lg-6">
        <div class="form-group has-error">
            ...
            <span class="form-text">{{ $dataTransaksi[0]->buyer_name }}</span>
    ...
    <div class="col-lg-6">
        <div class="form-group has-error">
            ...
            <span
                class="form-text">{{ \Carbon\Carbon::parse($dataTransaksi[0]->transaction_date)->format('d F Y  h:i') }}</span>
            <span class="has-error help-block"></span>
        </div>
    </div>
    <div class="col-lg-6">
        <div class="form-group has-error">
            ...
            <span class="form-text">{{ $dataTransaksi[0]->description }}</span>
            <span class="has-error help-block"></span>
        </div>
    </div>
    <div class="col-lg-12">
            ...
            <table class="table table-bordered global-table" width="100%" cellspacing="0">
                ...
                <tbody>
                    @foreach ($dataListBarang as $data => $value)
                        <tr>
                            <td>{{ $value->nama }} ISI ({{ $value->pack_size }})</td>
                ...
                <tfoot>
                    <tr>
                        ...
                        <td colspan="1">Rp. {{ number_format($dataTransaksi[0]->total_payment, 2, ',', '.') }}</td>
                    </tr>
                </tfoot>
            </table>
        </div>
    ...
    <div class="col-lg-6">
        <div class="form-group has-error">
            ...
            <span class="form-text">{{ $dataTransaksi[0]->paid }}</span>
            <span class="has-error help-block"></span>
        </div>
    </div>
    <div class="col-lg-6">
        <div class="form-group has-error">
            ...
            <span class="form-text">{{ $dataTransaksi[0]->return }}</span>
            <span class="has-error help-block"></span>
        </div>
    </div>
</div>
