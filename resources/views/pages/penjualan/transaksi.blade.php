  ...
  <div class="col-md-6">
    <div class="card shadow mb-4">
      ...
      <div class="card-body">
        <div class="row">
          <div class="col-lg-12">
            <div class="form-group has-error">
              <label class="form-control-label">Nama Pembeli : <span style="color: red">*</span></label>
              <input autocomplete="off" class="form-control" type="text" name="nama" placeholder="Masukan Nama" required>
          ...
          <div class="col-lg-12">
            <div class="form-group has-error">
              ...
              <input autocomplete="off" class="form-control" type="text" name="keterangan" placeholder="Masukan Keterangan" required>
              <span class="has-error help-block"></span>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12">
            <table class="table table-bordered global-table" width="100%" cellspacing="0" id="belanjaan">
              <thead>
                <tr>
              ...
              <tbody>
               {{--  <tr>
                  <td>1.</td>
                  <td>Baso Aci <br> Rp500</td>
                  <td><input autocomplete="off" class="form-control" type="text" name="jumlah_barang"></td>
                  <td>Rp 50000</td>
              ...
              <tfoot>
                <tr>
                  ...
                  <td colspan="2"><input type="hidden" name="total_pembayaran" value="'+parseInt($(this).data('harga'))+'" /> <div id='total-harga'>Rp 0</div></td>
                </tr>
              </tfoot>
            </table>
          </div>
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="form-group has-error">
              ...
              <input autocomplete="off" class="form-control bayar" type="text" name="bayar" placeholder="Masukan Jumlah Bayar" value=0 required min="1">
              <span class="has-error help-block"></span>
            </div>
          </div>
          <div class="col-lg-12">
            <div class="form-group has-error">
              ...
              <input autocomplete="off" class="form-control" type="text" name="kembalian" placeholder="Jumlah Kembalian" readonly="true">
              <span class="has-error help-block"></span>
            </div>
          </div>
        </div>
      ...
      <div class="card-footer" style="float: right; width: 100%"> 
        <button type="submit" id="btn-save-transaksi" class="btn btn-success float-right mr-10" ><i class ="fa fa-check"></i>  Selesai</button>
      </div>
      </form>
    </div>
...
<script>
 ...
 function formatNumber(x) {
    ...
    if ($('#belanjaan > tbody').find('#'+$(this).data('id')).length > 0) {
      ...
      $('#belanjaan > tbody').append(
        '<tr id="'+$(this).data('id')+'" data-harga="'+$(this).data('harga')+'">'+
          ...
          +'<td><input autocomplete="off" class="form-control jumlah_barang" oninput="this.value = !!this.value && Math.abs(this.value) > 0 ? Math.abs(this.value) : null"  max="10" data-id="'+$(this).data('id')+'" type="number" name="barang['+$(this).data('id')+'][qty]" min="1" value=1></td>'
          +'<td> <input type="hidden" class="harga_barang" name="barang['+$(this).data('id')+'][harga]" value="'+parseInt($(this).data('harga'))+'" /> <div id="total-hrg'+$(this).data('id')+'">Rp '+formatNumber($(this).data('harga'))+'</div></td>'
          +'<td><button class="btn btn-danger btn-circle hapus-barang" data-id="'+$(this).data('id')+'"><i class="fas fa-trash"></i></button></td>'
          +'</tr>'
      );
      count_all()
    }
  ...
  $('#form-transaksi').submit(function (e) {
    ...
    } else if (parseInt($('input[name ="bayar"').val()) < parseInt($('input[name ="total_pembayaran"').val())) {
      Swal.fire({
          type: 'warning',
          title: 'Oops...',
