    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered global-table" id="tableJenis" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            <th width="5%">No</th>
                            <th width="12%"><a href="javascript:void(0);" class="btn btn-primary btn-circle add-modal"
                                    data-jenis="jenis" data-url="{{ route('modal') }}"><i class="fa fa-plus"></i></a></th>
                            <th>Nama</th>
                            <th>Harga</th>
                        </tr>
                    </thead>
